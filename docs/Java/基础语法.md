...
![基本数据类型](../.vuepress/public/assets/image/JAVA/基本数据类型.jpg)

### n.3 引用数据类型

![引用数据类型](../.vuepress/public/assets/image/JAVA/引用数据类型.jpg)

### 	n.4 数组的内存图

![数组内存分配](../.vuepress/public/assets/image/JAVA/数组内存分配.jpg)

### 	n.5 两个数组指向同一个空间的内存图

![ 两个数组指向同一个空间的内存图](../.vuepress/public/assets/image/JAVA/两个数组指向同一个空间的内存图.jpg)

### n.6 方法调用的内存原理

![方法的出入栈](../.vuepress/public/assets/image/JAVA/方法的出入栈.jpg)                               

### n.7 二维数组的内存图

![二维数组内存图](../.vuepress/public/assets/image/JAVA/二维数组内存图1.jpg)

![二维数组的内存图](../.vuepress/public/assets/image/JAVA/二维数组的内存图2.jpg)

![二维数组内存图](../.vuepress/public/assets/image/JAVA/二维数组内存图3.jpg)
